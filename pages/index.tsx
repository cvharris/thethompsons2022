    ...
    <Layout>
      <header className="min-h-screen flex flex-col items-center relative pt-32 md:pt-20">
        <div className="relative px-12 md:px-24 pt-16 md:pt-32">
          ...
          <div className="absolute z-40 bottom-0 left-0 w-full transform md:-translate-x-4 -translate-y-20 md:-translate-y-48 flex items-center justify-center flex-grow">
            <div className="relative z-20">
              ...
              <div className="header-name-ampersand absolute z-0 top-0 h-full w-full flex justify-center items-center text-sky-300 text-opacity-70 font-vibes transform -translate-y-12 md:-translate-y-8 md:pt-16">
                <Parallax offset={200}>
                  <span>&</span>
                </Parallax>
              </div>
          ...
          <h2 className="fixed z-40 right-6 top-12 text-center text-indigo-900 text-lg font-bona flex flex-col p-2 bg-sky-50 bg-opacity-25 mt-6 md:m-12">
            <span>6</span>
            <span>/</span>
            <span>18</span>
          </h2>
      ...
      >
        ...
        <div className="relative max-w-screen-lg w-full mx-auto">
          <div className="absolute w-full h-full top-0 left-0 flex items-center z-0 transform md:translate-x-8 -translate-y-32 md:-translate-y-16">
          ...
          <div className="relative z-10 transform md:-translate-x-8 md:max-w-screen-md ml-auto pt-24 md:pt-8">
      ...
      <section
        id="reception"
        className="min-h-screen-75 flex flex-col items-center text-center font-cinzel"
      >
        <h3 className="relative z-20 font-cinzel text-center text-4xl sm:text-6xl pt-6 pb-24 sm:py-48 text-indigo-900">
          Reception
        </h3>
        <div className="relative max-w-screen-lg w-full mx-auto">
          ...
          <div className="absolute h-full w-full top-0 left-0 flex items-center justify-center transform -translate-y-16 md:-translate-y-32">
            <Parallax
      ...
      <section id="accomodations">
        <div className="pt-6 pb-32 md:py-32 text-center font-cinzel text-indigo-900">
      ...
      <section id="registry" className="flex flex-col bg-blueGray-100 pb-48">
        <div className="flex-grow flex flex-col">
          <h3 className="font-cinzel text-center text-4xl sm:text-6xl py-24 text-indigo-900">
            Registry
          </h3>
